...
class User implements UserInterface
{
    ...
    /**
     * @ORM\ManyToMany(targetEntity=Product::class, mappedBy="favorit")
     */
    private $favorit;
    ...
    public function addFavorit(Product $favorit): self
    {
    ...
    public function removeFavorit(Product $favorit): self
    {
